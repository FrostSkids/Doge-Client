...
public class PotionHelper
{
    ...
    public static int calcPotionLiquidColor(final Collection<PotionEffect> p_77911_0_) {
        final int i = 3694022;
        ...
        float f3 = 0.0f;
        float f4 = 0.0f;
        for (final PotionEffect potioneffect : p_77911_0_) {
    ...
    public static boolean getAreAmbient(final Collection<PotionEffect> potionEffects) {
    ...
    private static int parsePotionEffects(final String p_77912_0_, final int p_77912_1_, final int p_77912_2_, final int p_77912_3_) {
        ...
        if (i >= 0 && i < p_77912_2_) {
            ...
            final int j2 = parsePotionEffects(p_77912_0_, i + 1, p_77912_2_, p_77912_3_);
            return (j2 > 0) ? j2 : 0;
        }
        else {
            final int k = p_77912_0_.indexOf(38, p_77912_1_);
            if (k < 0 || k >= p_77912_2_) {
                boolean flag = false;
                boolean flag2 = false;
                boolean flag3 = false;
                ...
                for (int k2 = p_77912_1_; k2 < p_77912_2_; ++k2) {
                    ...
                    if (c0 >= '0' && c0 <= '9') {
                        ...
                        if (flag3) {
                            j3 += func_77904_a(flag4, flag2, flag5, m, l2, i2, p_77912_3_);
                            flag4 = false;
                            flag5 = false;
                            flag = false;
                            flag2 = false;
            ...
            final int i3 = parsePotionEffects(p_77912_0_, p_77912_1_, k - 1, p_77912_3_);
            if (i3 <= 0) {
                return 0;
            }
            final int k3 = parsePotionEffects(p_77912_0_, k + 1, p_77912_2_, p_77912_3_);
            return (k3 <= 0) ? 0 : ((i3 > k3) ? i3 : k3);
        }
    }
    
    public static List<PotionEffect> getPotionEffects(final int p_77917_0_, final boolean p_77917_1_) {
            ...
            if (potion != null && (!potion.isUsable() || p_77917_1_)) {
                ...
                if (s != null) {
                    ...
                    if (i > 0) {
                        ...
                        if (list == null) {
                            list = (List<PotionEffect>)Lists.newArrayList();
                        }
    ...
    public static int applyIngredient(int p_77913_0_, final String p_77913_1_) {
        ...
        int k = 0;
        for (int l = i; l < j; ++l) {
            final char c0 = p_77913_1_.charAt(l);
            if (c0 >= '0' && c0 <= '9') {
                k *= 10;
                k += c0 - '0';
                flag = true;
                ...
                if (flag) {
                    p_77913_0_ = brewBitOperations(p_77913_0_, k, flag3, flag2, flag4);
                    flag4 = false;
                    flag2 = false;
                    flag3 = false;
                    flag = false;
