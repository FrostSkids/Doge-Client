...
public class MathHelper
{
    ...
    static {
        ...
        for (int j = 0; j < 257; ++j) {
            ...
            MathHelper.field_181165_f[j] = Math.cos(d2);
            MathHelper.field_181164_e[j] = d2;
        }
    }
    
    public static float sin(final float p_76126_0_) {
        return MathHelper.SIN_TABLE[(int)(p_76126_0_ * 10430.378f) & 0xFFFF];
    }
    
    public static float cos(final float value) {
        return MathHelper.SIN_TABLE[(int)(value * 10430.378f + 16384.0f) & 0xFFFF];
    }
