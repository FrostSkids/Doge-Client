...
public class WorldRenderer
{
    ...
    public WorldRenderer tex(final double p_181673_1_, final double p_181673_3_) {
    ...
    private int getColorIndex(final int p_78909_1_) {
    ...
    private void putColorRGBA(final int index, final int red, final int p_178972_3_, final int p_178972_4_, final int p_178972_5_) {
        if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
    ...
    public WorldRenderer normal(final float p_181663_1_, final float p_181663_2_, final float p_181663_3_) {
        ...
        switch (this.field_181677_f.getType()) {
            ...
            case USHORT:
            case SHORT: {
                this.byteBuffer.putShort(i, (short)((int)p_181663_1_ * 32767 & 0xFFFF));
                this.byteBuffer.putShort(i + 2, (short)((int)p_181663_2_ * 32767 & 0xFFFF));
                this.byteBuffer.putShort(i + 4, (short)((int)p_181663_3_ * 32767 & 0xFFFF));
                break;
            }
            case UBYTE:
            case BYTE: {
