...
public class GuiScreenOptionsSounds extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new Button(SoundCategory.MASTER.getCategoryId(), GuiScreenOptionsSounds.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), SoundCategory.MASTER, true));
        i += 2;
        ...
        for (int length = (values = SoundCategory.values()).length, j = 0; j < length; ++j) {
            ...
            if (soundcategory != SoundCategory.MASTER) {
                this.buttonList.add(new Button(soundcategory.getCategoryId(), GuiScreenOptionsSounds.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), soundcategory, false));
                ++i;
            }
        }
        this.buttonList.add(new GuiButton(200, GuiScreenOptionsSounds.width / 2 - 100, this.height / 6 + 168, I18n.format("gui.done", new Object[0])));
    }
