...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    public void drawWorldBackground(final int tint) {
        if (this.mc.theWorld != null) {
            this.drawGradientRect(0, 0, GuiScreen.width, this.height, -1072689136, -804253680);
        }
        else {
    ...
    public void drawBackground(final int tint) {
        ...
        GuiHelper.drawBackgroundPicture(GuiScreen.width, this.height, "Client/wallpaper.png");
    }
