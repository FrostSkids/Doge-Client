...
public class GuiControls extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, GuiControls.width / 2 - 155, this.height - 29, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(this.buttonReset = new GuiButton(201, GuiControls.width / 2 - 155 + 160, this.height - 29, 150, 20, I18n.format("controls.resetAll", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, GuiControls.width / 2, 8, 16777215);
        boolean flag = true;
        KeyBinding[] keyBindings;
