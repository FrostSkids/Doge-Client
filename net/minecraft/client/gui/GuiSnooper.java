...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146605_t = new GuiButton(1, GuiSnooper.width / 2 - 152, this.height - 30, 150, 20, this.game_settings_2.getKeyBinding(GameSettings.Options.SNOOPER_ENABLED)));
        this.buttonList.add(new GuiButton(2, GuiSnooper.width / 2 + 2, this.height - 30, 150, 20, I18n.format("gui.done", new Object[0])));
    ...
    {
        public List() {
            super(GuiSnooper.this.mc, GuiSnooper.width, GuiSnooper.this.height, 80, GuiSnooper.this.height - 40, GuiSnooper.this.fontRendererObj.FONT_HEIGHT + 1);
        }
