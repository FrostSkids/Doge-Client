...
public class GuiCreateFlatWorld extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_146389_t = new GuiButton(2, GuiCreateFlatWorld.width / 2 - 154, this.height - 52, 100, 20, String.valueOf(I18n.format("createWorld.customize.flat.addLayer", new Object[0])) + " (NYI)"));
        this.buttonList.add(this.field_146388_u = new GuiButton(3, GuiCreateFlatWorld.width / 2 - 50, this.height - 52, 100, 20, String.valueOf(I18n.format("createWorld.customize.flat.editLayer", new Object[0])) + " (NYI)"));
        this.buttonList.add(this.field_146386_v = new GuiButton(4, GuiCreateFlatWorld.width / 2 - 155, this.height - 52, 150, 20, I18n.format("createWorld.customize.flat.removeLayer", new Object[0])));
        this.buttonList.add(new GuiButton(0, GuiCreateFlatWorld.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new GuiButton(5, GuiCreateFlatWorld.width / 2 + 5, this.height - 52, 150, 20, I18n.format("createWorld.customize.presets", new Object[0])));
        this.buttonList.add(new GuiButton(1, GuiCreateFlatWorld.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    class Details extends GuiSlot
    {
        ...
        public Details() {
            super(GuiCreateFlatWorld.this.mc, GuiCreateFlatWorld.width, GuiCreateFlatWorld.this.height, 43, GuiCreateFlatWorld.this.height - 60, 24);
