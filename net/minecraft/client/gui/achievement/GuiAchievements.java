...
public class GuiAchievements extends GuiScreen implements IProgressMeter
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiOptionButton(1, GuiAchievements.width / 2 + 24, this.height / 2 + 74, 80, 20, I18n.format("gui.done", new Object[0])));
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.loadingAchievements) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), GuiAchievements.width / 2, this.height / 2, 16777215);
            this.drawCenteredString(this.fontRendererObj, GuiAchievements.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiAchievements.lanSearchStates.length)], GuiAchievements.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else {
            if (Mouse.isButtonDown(0)) {
                final int i = (GuiAchievements.width - this.field_146555_f) / 2;
    ...
    protected void drawAchievementScreen(final int p_146552_1_, final int p_146552_2_, final float p_146552_3_) {
        ...
        final int k = (GuiAchievements.width - this.field_146555_f) / 2;
