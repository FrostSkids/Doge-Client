...
public class GuiStats extends GuiScreen implements IProgressMeter
{
    ...
    public void createButtons() {
        this.buttonList.add(new GuiButton(0, GuiStats.width / 2 + 4, this.height - 28, 150, 20, I18n.format("gui.done", new Object[0])));
        this.buttonList.add(new GuiButton(1, GuiStats.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton", new Object[0])));
        final GuiButton guibutton;
        this.buttonList.add(guibutton = new GuiButton(2, GuiStats.width / 2 - 80, this.height - 52, 80, 20, I18n.format("stat.blocksButton", new Object[0])));
        final GuiButton guibutton2;
        this.buttonList.add(guibutton2 = new GuiButton(3, GuiStats.width / 2, this.height - 52, 80, 20, I18n.format("stat.itemsButton", new Object[0])));
        final GuiButton guibutton3;
        this.buttonList.add(guibutton3 = new GuiButton(4, GuiStats.width / 2 + 80, this.height - 52, 80, 20, I18n.format("stat.mobsButton", new Object[0])));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(this.fontRendererObj, I18n.format("multiplayer.downloadingStats", new Object[0]), GuiStats.width / 2, this.height / 2, 16777215);
            this.drawCenteredString(this.fontRendererObj, GuiStats.lanSearchStates[(int)(Minecraft.getSystemTime() / 150L % GuiStats.lanSearchStates.length)], GuiStats.width / 2, this.height / 2 + this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        }
        else {
    ...
    abstract class Stats extends GuiSlot
    {
        ...
        protected Stats(final Minecraft mcIn) {
            super(mcIn, GuiStats.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 20);
    ...
    class StatsGeneral extends GuiSlot
    {
        public StatsGeneral(final Minecraft mcIn) {
            super(mcIn, GuiStats.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 10);
            this.setShowSelectionBox(false);
        }
    ...
    class StatsMobsList extends GuiSlot
    {
        ...
        public StatsMobsList(final Minecraft mcIn) {
            super(mcIn, GuiStats.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
