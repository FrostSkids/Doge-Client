...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(200, GuiVideoSettings.width / 2 - 100, this.height - 27, I18n.format("gui.done", new Object[0])));
        if (!OpenGlHelper.vboSupported) {
            ...
            this.optionsRowList = new GuiOptionsRowList(this.mc, GuiVideoSettings.width, this.height, 32, this.height - 32, 25, agamesettings$options);
        }
        else {
            this.optionsRowList = new GuiOptionsRowList(this.mc, GuiVideoSettings.width, this.height, 32, this.height - 32, 25, GuiVideoSettings.videoOptions);
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.screenTitle, GuiVideoSettings.width / 2, 5, 16777215);
