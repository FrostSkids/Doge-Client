...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void func_146618_g() {
        this.buttonList.add(this.selectButton = new GuiButton(1, GuiSelectWorld.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select", new Object[0])));
        this.buttonList.add(new GuiButton(3, GuiSelectWorld.width / 2 + 4, this.height - 52, 150, 20, I18n.format("selectWorld.create", new Object[0])));
        this.buttonList.add(this.renameButton = new GuiButton(6, GuiSelectWorld.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.rename", new Object[0])));
        this.buttonList.add(this.deleteButton = new GuiButton(2, GuiSelectWorld.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete", new Object[0])));
        this.buttonList.add(this.recreateButton = new GuiButton(7, GuiSelectWorld.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate", new Object[0])));
        this.buttonList.add(new GuiButton(0, GuiSelectWorld.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel", new Object[0])));
    ...
    class List extends GuiSlot
    {
        public List(final Minecraft mcIn) {
            super(mcIn, GuiSelectWorld.width, GuiSelectWorld.this.height, 32, GuiSelectWorld.this.height - 64, 36);
        }
