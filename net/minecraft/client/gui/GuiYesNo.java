...
public class GuiYesNo extends GuiScreen
{
    ...
    @Override
    public void initGui() {
        this.buttonList.add(new GuiOptionButton(0, GuiYesNo.width / 2 - 155, this.height / 6 + 96, this.confirmButtonText));
        this.buttonList.add(new GuiOptionButton(1, GuiYesNo.width / 2 - 155 + 160, this.height / 6 + 96, this.cancelButtonText));
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (final String s : this.field_175298_s) {
            this.drawCenteredString(this.fontRendererObj, s, GuiYesNo.width / 2, i, 16777215);
