...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui() {
        ...
        (this.inputField = new GuiTextField(0, this.fontRendererObj, 4, this.height - 12, GuiChat.width - 4, 12)).setMaxStringLength(100);
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        Gui.drawRect(2, this.height - 14, GuiChat.width - 2, this.height - 2, Integer.MIN_VALUE);
