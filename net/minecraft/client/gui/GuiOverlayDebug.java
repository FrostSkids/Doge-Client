...
public class GuiOverlayDebug extends Gui
{
    ...
    protected List<String> call() {
        ...
        if (this.isReducedDebug()) {
            return (List<String>)Lists.newArrayList((Object[])new String[] { ClientInfos.ClientName, this.mc.debug, this.mc.renderGlobal.getDebugInfoRenders(), this.mc.renderGlobal.getDebugInfoEntities(), "P: " + this.mc.effectRenderer.getStatistics() + ". T: " + this.mc.theWorld.getDebugLoadedEntities(), this.mc.theWorld.getProviderName(), "", String.format("Chunk-relative: %d %d %d", blockpos.getX() & 0xF, blockpos.getY() & 0xF, blockpos.getZ() & 0xF) });
        }
    ...
    protected List<String> getDebugInfoRight() {
        ...
        if (this.mc.objectMouseOver != null && this.mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && this.mc.objectMouseOver.getBlockPos() != null) {
            ...
            for (final Map.Entry<IProperty, Comparable> entry : iblockstate.getProperties().entrySet()) {
                ...
                list.add(String.valueOf(entry.getKey().getName()) + ": " + s);
            }
        }
        return list;
    }
