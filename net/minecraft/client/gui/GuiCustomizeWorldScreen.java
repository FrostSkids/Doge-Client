...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_175346_u = new GuiButton(304, GuiCustomizeWorldScreen.width / 2 - 187, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.defaults", new Object[0])));
        this.buttonList.add(this.field_175347_t = new GuiButton(301, GuiCustomizeWorldScreen.width / 2 - 92, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.randomize", new Object[0])));
        this.buttonList.add(this.field_175350_z = new GuiButton(305, GuiCustomizeWorldScreen.width / 2 + 3, this.height - 27, 90, 20, I18n.format("createWorld.customize.custom.presets", new Object[0])));
        this.buttonList.add(this.field_175348_s = new GuiButton(300, GuiCustomizeWorldScreen.width / 2 + 98, this.height - 27, 90, 20, I18n.format("gui.done", new Object[0])));
    ...
    private void func_175325_f() {
        ...
        this.field_175349_r = new GuiPageButtonList(this.mc, GuiCustomizeWorldScreen.width, this.height, 32, this.height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][] { aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3, aguipagebuttonlist$guilistentry4 });
        for (int i = 0; i < 4; ++i) {
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.field_175339_B != 0) {
            Gui.drawRect(0, 0, GuiCustomizeWorldScreen.width, this.height, Integer.MIN_VALUE);
