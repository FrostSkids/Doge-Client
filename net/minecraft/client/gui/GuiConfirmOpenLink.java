...
public class GuiConfirmOpenLink extends GuiYesNo
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, GuiConfirmOpenLink.width / 2 - 50 - 105, this.height / 6 + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new GuiButton(2, GuiConfirmOpenLink.width / 2 - 50, this.height / 6 + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new GuiButton(1, GuiConfirmOpenLink.width / 2 - 50 + 105, this.height / 6 + 96, 100, 20, this.cancelButtonText));
    }
