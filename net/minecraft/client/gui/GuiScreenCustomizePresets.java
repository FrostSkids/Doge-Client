...
public class GuiScreenCustomizePresets extends GuiScreen
{
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.field_175316_h = new GuiButton(0, GuiScreenCustomizePresets.width / 2 - 102, this.height - 27, 100, 20, I18n.format("createWorld.customize.presets.select", new Object[0])));
        this.buttonList.add(new GuiButton(1, GuiScreenCustomizePresets.width / 2 + 3, this.height - 27, 100, 20, I18n.format("gui.cancel", new Object[0])));
        this.func_175304_a();
    }
    ...
    class ListPreset extends GuiSlot
    {
        ...
        public ListPreset() {
            super(GuiScreenCustomizePresets.this.mc, GuiScreenCustomizePresets.width, GuiScreenCustomizePresets.this.height, 80, GuiScreenCustomizePresets.this.height - 32, 38);
