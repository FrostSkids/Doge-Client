    ...
    public void initGui() {
        ...
        for (int length = (field_152312_a = GuiStreamOptions.field_152312_a).length, j = 0; j < length; ++j) {
            ...
            if (gamesettings$options.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options));
            }
            else {
                this.buttonList.add(new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options, this.field_152318_h.getKeyBinding(gamesettings$options)));
            }
            ++i;
        }
        if (i % 2 == 1) {
        ...
        for (int length2 = (field_152316_f = GuiStreamOptions.field_152316_f).length, k = 0; k < length2; ++k) {
            ...
            if (gamesettings$options2.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options2.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options2));
            }
            else {
                this.buttonList.add(new GuiOptionButton(gamesettings$options2.returnEnumOrdinal(), GuiStreamOptions.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), gamesettings$options2, this.field_152318_h.getKeyBinding(gamesettings$options2)));
            }
            ++i;
        }
        this.buttonList.add(new GuiButton(200, GuiStreamOptions.width / 2 - 155, this.height / 6 + 168, 150, 20, I18n.format("gui.done", new Object[0])));
        final GuiButton guibutton = new GuiButton(201, GuiStreamOptions.width / 2 + 5, this.height / 6 + 168, 150, 20, I18n.format("options.stream.ingestSelection", new Object[0]));
