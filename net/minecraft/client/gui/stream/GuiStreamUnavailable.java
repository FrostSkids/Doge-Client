...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    public void initGui() {
        ...
        if (this.field_152326_h.func_152559_b() != null) {
            this.buttonList.add(new GuiButton(0, GuiStreamUnavailable.width / 2 - 155, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
            this.buttonList.add(new GuiButton(1, GuiStreamUnavailable.width / 2 - 155 + 160, this.height - 50, 150, 20, I18n.format(this.field_152326_h.func_152559_b().getFormattedText(), new Object[0])));
        }
        else {
            this.buttonList.add(new GuiButton(0, GuiStreamUnavailable.width / 2 - 75, this.height - 50, 150, 20, I18n.format("gui.cancel", new Object[0])));
        }
    }
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, this.field_152324_f.getFormattedText(), GuiStreamUnavailable.width / 2, i - this.fontRendererObj.FONT_HEIGHT * 2, 16777215);
        for (final String s : this.field_152323_r) {
            this.drawCenteredString(this.fontRendererObj, s, GuiStreamUnavailable.width / 2, i, 10526880);
