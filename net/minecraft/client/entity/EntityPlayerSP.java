...
import Main.ClientMovementInput;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public ClientMovementInput movementInput;
    ...
    public void onLivingUpdate() {
        ...
        if (this.isUsingItem() && !this.isRiding()) {
            final ClientMovementInput movementInput = this.movementInput;
            movementInput.moveStrafe *= 0.2f;
            final ClientMovementInput movementInput2 = this.movementInput;
